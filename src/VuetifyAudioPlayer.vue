<template>
    <v-card class="mt-5" ref="playerContainer" :loading="!audioDownloaded" v-bind="$attrs">
        <v-img
                ...
                >
                    ...
                    <div :class="compact ? 'mx-2' : 'mx-3'">
                        <v-btn icon :disabled="!audioDownloaded" @click="playing = !playing">
                            <v-icon size="30" v-text="playing ? 'mdi-pause' : 'mdi-play'"></v-icon>
                        </v-btn>
                    </div>
